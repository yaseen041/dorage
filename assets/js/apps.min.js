...
menuDropdown.each(function() {
    $(this).on("click", function() {
        $(this).toggleClass("expand-menu"), menuDropdown.not(this).removeClass("expand-menu")
    })
}), $(".slide-topbar").slick({
    dots: !1,
    arrows: !1,
    ...
    autoplay: !0,
    autoplaySpeed: 2e3
}), $(this).scrollTop() > 170 ? siteHeader.addClass("scrolled") : siteHeader.removeClass("scrolled"), $(window).on("scroll", function() {
...
function() {
    ...
    0 === $(e.target).closest("#customizer").length && customizer.removeClass("customizer-open")
});
...
$("#header-style").on("click", "a", function(event) {
    ...
    return headerStyleOption.removeClass("active"), $(this).addClass("active"), "header-1" === headerStyle ? siteBody.removeClass(function(index, className) {
        return (className.match(/(^|\s)header-\S+/g) || []).join(" ")
    }) : "header-2" === headerStyle ? siteBody.removeClass(function(index, className) {
        return (className.match(/(^|\s)header-\S+/g) || []).join(" ")
    }) : "header-3" === headerStyle && siteBody.removeClass(function(index, className) {
        return (className.match(/(^|\s)header-\S+/g) || []).join(" ")
    }), siteBody.addClass(headerStyle), btnHeaderStyle.html(headerStyleName + caret), btnHeaderStyle.val($(this).text()), setCookie("cookie_header", headerStyle), event.preventDefault(), !1
});
...
$("#page-header-style").on("click", "a", function(event) {
    ...
    return pageHeaderStyleOption.removeClass("active"), $(this).addClass("active"), "page-header-1" === pageHeaderStyle ? siteBody.removeClass(function(index, className) {
        return (className.match(/(^|\s)page-header-\S+/g) || []).join(" ")
    }) : "page-header-2" === pageHeaderStyle ? siteBody.removeClass(function(index, className) {
        return (className.match(/(^|\s)page-header-\S+/g) || []).join(" ")
    }) : "page-header-3" === pageHeaderStyle ? siteBody.removeClass(function(index, className) {
        return (className.match(/(^|\s)page-header-\S+/g) || []).join(" ")
    }) : "page-header-4" === pageHeaderStyle && siteBody.removeClass(function(index, className) {
        return (className.match(/(^|\s)page-header-\S+/g) || []).join(" ")
    }), siteBody.addClass(pageHeaderStyle), btnPageHeaderStyle.html(pageHeaderStyleName + caret), btnPageHeaderStyle.val($(this).text()), setCookie("cookie_page_header", pageHeaderStyle), event.preventDefault(), !1
});
...
colorTemplate ? ($("#theme-options a").removeClass("active"), $("a#" + colorTemplate).addClass("active"), setTheme(colorTemplate)) : setTheme("brand-default"), $("#theme-options").on("click", "a", function(event) {
    ...
    $(window).scroll(function() {
        ...
        header.hasClass("scrolled") ? (mapWrapper.addClass("on-scrolled"), $(window).width() > 991 ? mapWrapper.css("top", 0) : $(window).width() > 1198 ? (mapWrapper.css("top", "72px"), idMap.css("height", "100vh !important")) : $(this).scrollTop() > contentHeight ? (mapWrapper.addClass("sticky-off"), mapWrapper.css("top", "auto")) : mapWrapper.removeClass("sticky-off")) : (mapWrapper.removeClass("on-scrolled"), $(window).width() > 991 && mapWrapper.css("top", heightHeader))
    }), $(window).ready(function() {
        $(window).width() > 991 ? searchResult.removeClass("container") : $(window).width() > 1200 && mapWrapper.css("top", "165px")
    })
}();
if ($("#booking-calendar").length) {
    ...
    $("#booking-calendar").dateRangePicker({
        ...
        hoveringTooltip: function(days, startTime, hoveringTime) {
            return midday ? days > 1 ? days - 1 + " " + appsLocalization.nightsText : "" : days > 1 ? days + " " + appsLocalization.daysText : ""
        },
        ...
        if ($("#booking-calendar").removeClass("select-first"), midday) {
            ...
            $("#booking-calendar").find(".first-date-booked, .first-date-unavailable").each(function() {
                $(this).attr("time") == nextStart && $(this).removeClass("invalid").addClass("valid")
            }), $("#booking-calendar").find(".last-date-booked, .last-date-unavailable").each(function() {
                $(this).attr("time");
        ...
        $("#booking-calendar").addClass("select-first"), midday && ($("#booking-calendar").find(".first-date-booked, .first-date-unavailable").each(function() {
            $(this).addClass("invalid").removeClass("valid")
        }), $("#booking-calendar").find(".last-date-booked, .last-date-unavailable").each(function() {
            $(this).addClass("valid").removeClass("invalid")
        }))
    }).find(".first-date-booked, .first-date-unavailable, .last-date-booked, .last-date-unavailable").each(function() {
        midday && ($(this).hasClass("first-date-booked") || $(this).hasClass("first-date-unavailable") ? $(this).addClass("invalid").removeClass("valid") : ($(this).hasClass("last-date-booked") || $(this).hasClass("last-date-unavailable")) && $(this).addClass("valid").removeClass("invalid"))
    })
}
var now = new Date,
...
$("#nb-end-date").val(afterTomorrow), $("#nb-start-date").length && $("#nb-start-date").dateRangePicker({
    format: "YYYY-MM-DD",
    autoClose: !0,
    singleDate: !0,
    showShortcuts: !1,
    singleMonth: !0,
    startDate: tomorrow
}), $("#nb-end-date").length && $("#nb-end-date").dateRangePicker({
    format: "YYYY-MM-DD",
    ...
    startAfterFirst = moment(firstValue, "YYYY-MM-DD").add(1, "day").startOf("day").valueOf(),
    afterFirst = moment(firstValue, "YYYY-MM-DD").add(1, "day").format("YYYY-MM-DD");
    moment(obj.value, "YYYY-MM-DD").startOf("day").valueOf() < startAfterFirst && $("#nb-end-date").data("dateRangePicker").setStart(afterFirst)
}), $(".btn-toggle-search").on("click", function(e) {
    $(this).toggleClass("active"), $(this).parents(".form-body").find(".advanced-search").slideToggle(100), e.preventDefault()
}), $(".btn-compare").on("click", function(e) {
    $(this).addClass("active"), $("#sidebar-compare").addClass("active"), $("#customizer-panel").hide(), e.preventDefault()
}), $(".compare-toggle").on("click", function(e) {
    $("#sidebar-compare").hasClass("active") ? ($(this).parents("#sidebar-compare").removeClass("active"), $("#customizer-panel").show()) : ($(this).parents("#sidebar-compare").addClass("active"), $("#customizer-panel").hide()), e.preventDefault()
...
// $("#nb-start-date1").val();
var today_day = now.getDay();
$("#nb-end-date1").val(afterTomorrow), $("#nb-start-date1").length && $("#nb-start-date1").dateRangePicker({
    format: "YYYY-MM-DD",
    autoClose: !0,
    singleDate: !0,
    showShortcuts: !1,
    singleMonth: !0,
    startDate: tomorrow
}), $("#nb-end-date1").length && $("#nb-end-date1").dateRangePicker({
    format: "YYYY-MM-DD",
    extraClass: "end-date-wrapper",
    autoClose: !0,
    singleDate: !0,
