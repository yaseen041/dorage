...
! function(a) {
    var b = function(a, b) {
        this.element = a, this.element.addClass("calendar"), this._initializeEvents(b), this._initializeOptions(b), this.setYear(this.options.startYear)
    };
    b.prototype = {
        constructor: b,
        _initializeOptions: function(b) {
            null == b && (b = []), this.options = {
        ...
        _initializeEvents: function(a) {
            null == a && (a = []), a.yearChanged && this.element.bind("yearChanged", a.yearChanged), a.renderEnd && this.element.bind("renderEnd", a.renderEnd), a.clickDay && this.element.bind("clickDay", a.clickDay), a.dayContextMenu && this.element.bind("dayContextMenu", a.dayContextMenu), a.selectRange && this.element.bind("selectRange", a.selectRange), a.mouseOnDay && this.element.bind("mouseOnDay", a.mouseOnDay), a.mouseOutDay && this.element.bind("mouseOutDay", a.mouseOutDay)
        },
        ...
        render: function() {
            this.element.empty(), this.options.displayHeader && this._renderHeader(), this._renderBody(), this._renderDataSource(), this._applyEvents(), this.element.find(".months-container").fadeIn(500), this._triggerEvent("renderEnd", {
                currentYear: this.options.startYear
            })
        },
        _renderHeader: function() {
            var b = a(document.createElement("div"));
            b.addClass("calendar-header panel panel-default");
            var c = a(document.createElement("table")),
                d = a(document.createElement("th"));
            d.addClass("prev"), null != this.options.minDate && this.options.minDate > new Date(this.options.startYear - 1, 11, 31) && d.addClass("disabled");
            var e = a(document.createElement("span"));
            e.addClass("glyphicon glyphicon-chevron-left"), d.append(e), c.append(d);
            var f = a(document.createElement("th"));
            f.addClass("year-title year-neighbor2 hidden-sm hidden-xs"), f.text(this.options.startYear - 2), null != this.options.minDate && this.options.minDate > new Date(this.options.startYear - 2, 11, 31) && f.addClass("disabled"), c.append(f);
            var g = a(document.createElement("th"));
            g.addClass("year-title year-neighbor hidden-xs"), g.text(this.options.startYear - 1), null != this.options.minDate && this.options.minDate > new Date(this.options.startYear - 1, 11, 31) && g.addClass("disabled"), c.append(g);
            var h = a(document.createElement("th"));
            h.addClass("year-title"), h.text(this.options.startYear), c.append(h);
            var i = a(document.createElement("th"));
            i.addClass("year-title year-neighbor hidden-xs"), i.text(this.options.startYear + 1), null != this.options.maxDate && this.options.maxDate < new Date(this.options.startYear + 1, 0, 1) && i.addClass("disabled"), c.append(i);
            var j = a(document.createElement("th"));
            j.addClass("year-title year-neighbor2 hidden-sm hidden-xs"), j.text(this.options.startYear + 2), null != this.options.maxDate && this.options.maxDate < new Date(this.options.startYear + 2, 0, 1) && j.addClass("disabled"), c.append(j);
            var k = a(document.createElement("th"));
            k.addClass("next"), null != this.options.maxDate && this.options.maxDate < new Date(this.options.startYear + 1, 0, 1) && k.addClass("disabled");
            var l = a(document.createElement("span"));
            l.addClass("glyphicon glyphicon-chevron-right"), k.append(l), c.append(k), b.append(c), this.element.append(b)
        },
        _renderBody: function() {
            ...
            for (var d = 0; d < 12; d++) {
                ...
                e.addClass("month-container"), e.data("month-id", d);
                ...
                j.addClass("month-title"), j.attr("colspan", this.options.displayWeekNumber ? 8 : 7), j.text(c[this.options.language].months[d]), i.append(j), h.append(i);
                var k = a(document.createElement("tr"));
                if (this.options.displayWeekNumber) {
                    var l = a(document.createElement("th"));
                    l.addClass("week-number"), l.text(c[this.options.language].weekShort), k.append(l)
                }
                ...
                for (; p <= q;) {
                    ...
                    if (this.options.displayWeekNumber) {
                        ...
                        l.addClass("week-number"), l.text(this.getWeekNumber(p)), r.append(l)
                    }
                    do {
                        ...
                        if (s.addClass("day"), this._isHidden(p.getDay()) && s.addClass("hidden"), p < f) s.addClass("old");
                            ...
                            t.addClass("day-content"), t.text(p.getDate()), s.append(t), this.options.customDayRenderer && this.options.customDayRenderer(t, p)
                        }
                        r.append(s), p.setDate(p.getDate() + 1)
                    } while (p.getDay() != m);
                    g.append(r)
                }
                e.append(g), b.append(e)
            }
            ...
            switch (this.options.style) {
                case "border":
                    ...
                    if (1 == c.length ? d = 4 : c.length <= 3 ? d = 2 : a.parent().css("box-shadow", "inset 0 -4px 0 0 black"), d > 0) {
                        for (var e = "", f = 0; f < c.length; f++) "" != e && (e += ","), e += "inset 0 -" + (parseInt(f) + 1) * d + "px 0 0 " + c[f].color;
                        a.parent().css("box-shadow", e)
                    }
                    break;
                case "background":
                    a.parent().css("background-color", "#BABABA");
                    var g = b.getTime();
                    if (c[c.length - 1].startDate.getTime() == g)
                        if (a.parent().addClass("day-start"), c[c.length - 1].startHalfDay || this.options.alwaysHalfDay) {
                            a.parent().addClass("day-half");
                            for (var h = "transparent", f = c.length - 2; f >= 0; f--)
                                if (c[f].startDate.getTime() != g || !c[f].startHalfDay && !this.options.alwaysHalfDay) {
                                    h = c[f].color;
                                    break
                                }
                    ...
                    else if (c[c.length - 1].endDate.getTime() == g)
                        if (a.parent().addClass("day-end"), c[c.length - 1].endHalfDay || this.options.alwaysHalfDay) {
                            a.parent().addClass("day-half");
                            for (var h = "transparent", f = c.length - 2; f >= 0; f--)
                                if (c[f].endDate.getTime() != g || !c[f].endHalfDay && !this.options.alwaysHalfDay) {
                                    h = c[f].color;
                                    break
                                }
        ...
        _applyEvents: function() {
            ...
            this.element.find(".year-neighbor, .year-neighbor2").click(function() {
                ...
                a(this).hasClass("disabled") || b.element.find(".months-container").animate({
                    ...
                    b.element.find(".months-container").css("visibility", "hidden"), b.element.find(".months-container").css("margin-left", "0"), setTimeout(function() {
            ...
            c.click(function(c) {
                ...
                if (b._mouseDown) {
                    ...
                    if (!b.options.allowOverlap) {
                        ...
                        if (e < d)
                            for (var f = new Date(e.getFullYear(), e.getMonth(), e.getDate() + 1); e < d && !(b.getEvents(f).length > 0);) e.setDate(e.getDate() + 1), f.setDate(f.getDate() + 1);
                        else
                            for (var f = new Date(e.getFullYear(), e.getMonth(), e.getDate() - 1); e > d && !(b.getEvents(f).length > 0);) e.setDate(e.getDate() - 1), f.setDate(f.getDate() - 1);
                        d = e
                    }
                    var g = b._rangeEnd;
                    b._rangeEnd = d, g.getTime() != b._rangeEnd.getTime() && b._refreshRange()
                }
            }), a(window).mouseup(function(a) {
                if (b._mouseDown) {
                    b._mouseDown = !1, b._refreshRange();
                ...
                var c = a(b.element).width(),
                    ...
                    e = "month-container";
                e += 6 * d < c ? " col-xs-2" : 4 * d < c ? " col-xs-3" : 3 * d < c ? " col-xs-4" : 2 * d < c ? " col-xs-6" : " col-xs-12", a(b.element).find(".month-container").attr("class", e)
            }, 300)
        },
        ...
        _openContextMenu: function(b) {
            ...
            for (var d = this._getDate(b), e = this.getEvents(d), f = 0; f < e.length; f++) {
                ...
                g.addClass("item"), g.css("border-left", "4px solid " + e[f].color);
                var h = a(document.createElement("div"));
                h.addClass("content"), h.text(''), g.append(h);
                var i = a(document.createElement("span"));
                i.addClass("glyphicon glyphicon-chevron-right"), g.append(i), this._renderContextMenuItems(g, this.options.contextMenuItems, e[f]), c.append(g)
            }
        ...
        _renderContextMenuItems: function(b, c, d) {
            ...
            for (var f = 0; f < c.length; f++)
                if (!c[f].visible || c[f].visible(d)) {
                    var g = a(document.createElement("div"));
                    g.addClass("item");
                    var h = a(document.createElement("div"));
                    h.addClass("content"), h.text(c[f].text), g.append(h), c[f].click && ! function(a) {
                        g.click(function() {
                            c[a].click(d)
                        })
                    }(f);
                    var i = a(document.createElement("span"));
                    i.addClass("glyphicon glyphicon-chevron-right"), g.append(i), c[f].items && c[f].items.length > 0 && this._renderContextMenuItems(g, c[f].items, d), e.append(g)
                }
        ...
        _isDisabled: function(a) {
            ...
            if (this.options.disabledWeekDays.length > 0)
                for (var b = 0; b < this.options.disabledWeekDays.length; b++)
                    if (a.getDay() == this.options.disabledWeekDays[b]) return !0;
            if (this.options.disabledDays.length > 0)
                for (var b = 0; b < this.options.disabledDays.length; b++)
                    if (a.getTime() == this.options.disabledDays[b].getTime()) return !0;
            return !1
        },
        _isHidden: function(a) {
            if (this.options.hiddenWeekDays.length > 0)
                for (var b = 0; b < this.options.hiddenWeekDays.length; b++)
                    if (a == this.options.hiddenWeekDays[b]) return !0;
            return !1
        },
        getWeekNumber: function(a) {
            var b = new Date(a.getTime());
            b.setHours(0, 0, 0, 0), b.setDate(b.getDate() + 3 - (b.getDay() + 6) % 7);
        ...
        getEventsOnRange: function(a, b) {
            var c = [];
            if (this.options.dataSource && a && b)
                for (var d = 0; d < this.options.dataSource.length; d++) this.options.dataSource[d].startDate < b && this.options.dataSource[d].endDate >= a && c.push(this.options.dataSource[d]);
            return c
        },
        getYear: function() {
        ...
        setYear: function(a) {
            var b = parseInt(a);
            if (!isNaN(b)) {
                this.options.startYear = b, this.element.empty(), this.options.displayHeader && this._renderHeader();
        ...
        setStyle: function(a, b) {
            this.options.style = "background" == a || "border" == a || "custom" == a ? a : "border", b || this.render()
        },
        ...
        setDataSource: function(a, b) {
            this.options.dataSource = a instanceof Array ? a : [], this._initializeDatasourceColors(), b || this.render()
        },
        getWeekStart: function() {
            return this.options.weekStart ? this.options.weekStart : c[this.options.language].weekStart
        },
        setWeekStart: function(a, b) {
            this.options.weekStart = isNaN(parseInt(a)) ? null : parseInt(a), b || this.render()
        },
        addEvent: function(a, b) {
            this.options.dataSource.push(a), b || this.render()
        }
    }, a.fn.calendar = function(c) {
        var d = new b(a(this), c);
        return a(this).data("calendar", d), d
