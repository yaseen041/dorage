    ...
    if($_POST){
        ...
        if(count($result2) > 0)
        {
            if (empty($result->activation_key) && $result->status == '1' && $result->is_banned == '0') {
                ...
                $finalResult = array('msg' => 'error', 'response'=>"Dear User, <br> Your account has been banned due to suspicious activity. <br> If you feel that our actions are not justified, please <a href='".base_url()."contact_us'>contact us </a> for further assistance. <br> Thank you.");
                echo json_encode($finalResult);
                exit;
            } elseif($result->status == '0') {
                $finalResult = array('msg' => 'error', 'response'=>"Dear User, <br> Your account has been inactive due to suspicious activity. <br> If you feel that our actions are not justified, please <a href='".base_url()."contact_us'>contact us </a> for further assistance. <br> Thank you.");
                echo json_encode($finalResult);
                exit;
            }
        }
