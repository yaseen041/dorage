				...
				<div class="panel with-nav-tabs panel-default">
					<div class="panel-heading">
						<ul class="nav nav-tabs">
							...
							<li><a href="#tab5default" data-toggle="tab">Mover Booking</a></li>
							<?php } ?>
							<li><a href="#tab2default" data-toggle="tab">Cancelled Booking</a></li>
							<li><a href="#tab3default" data-toggle="tab">Refunded Booking</a></li>
							<li><a href="#tab4default" data-toggle="tab">Completed Booking</a></li>
						</ul>
					</div>
					<div class="panel-body">
						<div class="tab-content">
										...
										<div class="row">
											<div class="col-lg-5">
												<a href="javascript:void(0)" class="property-image listing-property-img">
													<img src="<?php echo base_url(); ?>assets/storage_images/<?php echo get_booked_list_image($list['listings_id']); ?>" alt="Image not found">
												</a>
											</div>
											<div class="col-lg-7">
												<div class="property-content listing-content">
													<div class="row">
														...
														<div class="col-md-6">
															...
															<a class="popoverData pull-right" href="javascript:void(0)" data-content="<?php echo $customer; ?>" rel="popover" data-placement="left" data-html="true" data-original-title="Owner Detail" data-trigger="hover">Owner Detail</a>
														</div>
														<div class="col-md-12">
													...
													<div class="row">
														<div class="col-md-6">
															<p>
																<span>
																	Paid amount : $<?php echo number_format($list['total_amount']); ?>
																</span>
															</p>
														</div>
														<div class="col-md-6">
												...
												<div class="property-content listing-content">
													...
													<div class="row">
														<div class="col-md-12">
															...
															<!-- <span class="property-label">
																<a href="javascript:void(0)" class="btn btn-danger" data-id="<?php //echo $list['booking_id']; ?>"> Refund </a>
															</span> -->
							...
							<div class="tab-pane fade bookings_list" id="tab3default">
							...
							<div class="tab-pane fade bookings_list" id="tab4default">
								<?php if(empty($completed_bookings) && empty($completed_mover_bookings)): ?>
									<p> Booking not found. </p>
								<?php endif; ?>
												...
												<div class="property-content listing-content">
													...
													<div class="row">
														<div class="col-md-12">
															...
															<span class="property-label">
																<a href="javascript:void(0)" class="btn btn-success bookingReview" data-id="<?php echo $list['booking_id']; ?>">
								...
								<?php foreach ($completed_mover_bookings as $list): ?>
									<div class="property-item booking-item booking_item_<?php echo $list['id']; ?> property-archive col-lg-12 col-md-6 col-sm-6 no-padding">
										<div class="row">
											<div class="col-lg-5">
												<a href="javascript:void(0)" class="property-image listing-property-img">
													<img src="<?php echo base_url(); ?>assets/storage_images/<?php echo get_booked_list_image($list['mover_id']); ?>" alt="Image not found">
												</a>
											</div>
											<div class="col-lg-7">
												<div class="property-content listing-content">
													<h5 class="property-title pull-right">
														Booking REF # <?php echo $list['id']; ?>
													</h5>
													<h3 class="property-title">
														<?php echo $list['title']; ?>
													</h3>
													...
													<?php 
													$charge = (empty(get_booked_meta_value('crew_charges', $list['mover_id'])))?0:get_booked_meta_value('crew_charges', $list['mover_id']); ?>
													<p>
														<strong>Total Hours:</strong> <?php echo $list['no_hours']; ?>
														<br>
														<strong>No. of Crews:</strong> <?php echo $list['no_crews']; ?>
														<br>
														<strong>Charge Per Crew:</strong> $<?php echo $charge; ?>/hour
														<br>
														<strong>Total Charges: </strong> $<?php echo number_format($charge*$list['no_crews']*($list['no_hours'])); ?> 
														<br>
														<strong>Refundable Amount: </strong> $<?php echo number_format($charge*$list['no_crews']); ?> 
													</p>
													<?php $review = getUserReview($list['booking_id']);
													if (empty($review)) { ?>
													<a href="javascript:void(0)" class="label label-success bookingReview" data-id="<?php echo $list['booking_id']; ?>">Leave Booking Review</a>
													<?php }else{ ?>
													<strong>Your Review:</strong>
													<select class="reviewStars">
														<option <?php echo ($review['stars'] == 1)?"selected":""; ?> value="1">1</option>
							...
							<div class="tab-pane fade bookings_list" id="tab5default">
