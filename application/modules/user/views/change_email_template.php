				...
				<table>
					<tr>
						<td class="table-td-wrap" align="center" width="558">
														...
														<td class="table-col-td" width="478" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal; width: 478px;" valign="top" align="left">
															<table class="header-row" width="478" cellspacing="0" cellpadding="0" border="0" style="table-layout: fixed;">
																<tbody>
																	...
																	<tr>
																		<td class="header-row-td" width="478" style="font-family: Arial, sans-serif; font-weight: normal; line-height: 19px; color: #478fca; margin: 0px; font-size: 18px; padding-bottom: 10px; padding-top: 15px;" valign="top" align="left">
																			<legend> 
																			Change Email  Request! </legend> <br>
																		</td>
																	</tr>
																</tbody>
															</table>
															<div style="font-family: Arial, sans-serif; line-height: 20px; color: #444444; font-size: 13px; width: 100%;">
																<legend><b style="color: #777777;"> Hi <?php echo get_session('username'); ?>,</b> </legend>
																<br>
																Please confirm that your email address is correct to continue. click the link below to change email.
																
																<a href="<?php echo base_url(); ?>home/change_email/<?php echo $unique_id; ?>">
																	<?php echo base_url(); ?>home/change_email/<?php echo $unique_id; ?>
																</a>
																</p>
																<br>
																...
																<hr style="margin-top: 10px; margin-bottom: 10px;">
																<br>
																<p> If you have any further questions please contact us at <a href="mailto:<?php echo get_section_content('contactus' , 'contactus_email'); ?>"><?php echo get_section_content('contactus' , 'contactus_email'); ?></a> </p>
																<br>
																<p> <b> Kind Regards,<br>
																Dorage Support </b> </p>

																<p> <legend> <b> Thank You... !  </b></legend></p>
							...
							<table class="table-row-fixed" width="550" bgcolor="#FFFFFF" style="table-layout: fixed; background-color: #ffffff;" cellspacing="0" cellpadding="0" border="0">
								<tbody>
									<tr>
										<td class="table-row-fixed-td" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal; padding-left: 1px; padding-right: 1px;" valign="top" align="left">
											<table class="table-col" align="left" width="448" cellspacing="0" cellpadding="0" border="0" style="table-layout: fixed;">
												<tbody>
													<tr>
														<td class="table-col-td" width="548" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal;" valign="top" align="left">
																...
																<tbody>
																	<tr>
																		<td width="100%" align="center" bgcolor="#f5f5f5" style="font-family: Arial, sans-serif; line-height: 24px; color: #bbbbbb; font-size: 13px; font-weight: normal; text-align: center; padding: 9px; border-width: 1px 0px 0px; border-style: solid; border-color: #e3e3e3; background-color: #f5f5f5;" valign="top">
																			<a href="#" style="color: #428bca; text-decoration: none; background-color: transparent;">Copyright &copy; <?php echo date("Y"); ?> Dorage.</a>
																			<br>
																		</td>
																	</tr>
																</tbody>
