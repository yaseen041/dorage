		...
		<div class="row">
			...
			<div class="col-lg-7">
				<div class="property-content listing-content">
					...
					<p>
						<strong>Selected Hours:</strong> <?php echo $number_of_hours; ?>
						<br>
						...
						<br>
						<strong>Refundable Amount: </strong> $<?php echo $charge*$number_of_people; ?> 
					</p>
					<div class="col-lg-12">
						<div class="form-check">
							<button type="button" style="margin-top: 15px;" class="btn btn-info btn-sm apply_mover_details pull-right" data-mover-id="<?php echo $mover_list['id']; ?>"> Book Mover </button>
						</div>
					</div>
				</div>
			</div>
