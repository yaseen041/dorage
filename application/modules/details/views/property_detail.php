			...
			<div class="col-md-8">
					...
					<article class="post property-item">
						<div class="post-property-header">
							...
							<div class="row">
								...
								<div class="col-md-12">
									<div class="rating">
										<?php $listingReviews = getapprovedListingRating($list_detail['id']); ?>
										<div class="stars">
							...
							<div class="row">
								...
								<div class="col-md-9 col-sm-9">
									<ul class="feature-list">
										<?php if (empty($basic_space_rules)) { ?>
										<li> Not found </li>
										<?php } ?> 
						...
						<div id="comments" class="comments-area compact">
							...
							<div class="entry-comments">
								...
								<ol class="comment-list">
									<?php $reviews = getappovedListingReviews($list_detail['id']); ?>
									<!-- Comment Parent  -->
									<?php 
									if (!empty($reviews)) {
						...
						<div class="property-list archive-flex">
							<div class="row">
								...
								$similar_lists = get_similar_lists($list_detail['id'] ,$list_detail['latitude'] ,$list_detail['longitude'] , get_meta_value('storage_size_type' , @$list_detail['id']) , get_meta_value('space_storage_type' , @$list_detail['id']) , get_space_character_ids(@$list_detail['id']));

								if(empty($similar_lists)) { ?>

								<div class="col-lg-6 col-md-6 col-sm-6">

									<p style="padding-left: 25px;"> No Results Found. </p>
				...
				<div class="col-md-4">
					...
					<div id="sidebar">
						...
						<?php if($list_detail['users_id'] != get_session('user_id')): ?>
							<div class="widget">
								<div class="panel-box">
									<div class="panel-header">
