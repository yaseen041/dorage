...
<head>
    ...
    <!-- Animate.css -->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>admin_assets/bower_components/animate.css/animate.css">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>admin_assets/pages/dashboard/horizontal-timeline/css/style.css">
    <!-- amchart css -->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>admin_assets/pages/dashboard/amchart/css/amchart.css">
    <!-- flag icon framework css -->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>admin_assets/pages/flag-icon/flag-icon.min.css">
    <!-- Style.css -->
