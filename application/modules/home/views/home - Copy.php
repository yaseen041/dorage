								...
								<div class="form-body">
									...
									<div class="row adv-search">
										<div class="col-md-10 col-sm-10 col-xs-12 no-padd-left no-padd-right">
											<div class="col-md-4 col-sm-4 col-xs-12 form-group no-padd-left no-padd-right">

												<input type="text" class="form-control index-control" placeholder="Any Location" name="place" id="property_loc" onkeydown="if($('.pac-container').is(':visible') && event.keyCode == 13) {event.preventDefault();}" required>
												<input name="lat_long" id="property_lat_long" type="hidden">
											</div>
											<div class="col-md-5 col-sm-5 col-xs-12 form-group form-group--date no-padd-right no-padd-left">
					...
					<div class="row row-eq-height">
						<div class="col-md-6">
							<a href="<?php echo base_url(); ?>details/storage/<?php echo $featured_list['unique_id'].'/'.dorage_url_title($featured_list['title'])."/".md5($featured_list['title']); ?>" class="property-image">
								<img src="<?php echo base_url(); ?>assets/storage_images/<?php echo get_list_image($featured_list['id']); ?>" alt="list Image">
							</a>
						...
						<div class="col-md-6">
							<div class="property-content">
								...
								<p class="property-descriptio">
									<?php 
									$split = str_split($featured_list['description'], 300);
									$final = $split[0] . "...";
									echo $final;
									?>
								</p>
