  ...
  <div class="page-wrapper">
    <div class="page-header">
      <div class="page-header-title">
        <h4>Deleted Storage Space Listings</h4>
      </div>
...
<script type="text/javascript">
  $('body').on('click', '.restore_list', function (event) {
    ...
    swal({
      title: "Are you sure?",
      text: "You want to restore this storage!",
      type: "warning",
  ...
  $('body').on('click', '.delete_storage', function (event) {
    ...
    swal({
      title: "Are you sure?",
      text: "You want to delete this storage. You will not be able to recover this action!",
      type: "warning",
      showCancelButton: true,
