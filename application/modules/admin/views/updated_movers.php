              ...
              <table id="crm-contact" class="table table-striped dt-responsive nowrap">
                ...
                <tbody>
                  ...
                  <td class="action-icon">
                    ...
                    <label class="btn btn-primary btn-sm change_status" data-id="<?php echo $list['unique_id']; ?>"  data-status="make_mover_active"> Active </label>
