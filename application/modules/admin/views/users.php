              ...
              <table id="crm-contact" class="table table-striped dt-responsive nowrap">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td> <?php echo wordwrap($user['address2'], 25, "<br>\n"); ?> </td>
                    ...
                    <td> <?php echo wordwrap($user['about'], 80, "<br>\n"); ?> </td>
                    <td>
                      <?php if($user['status']) {?>
                      ...
                      <?php if($user['is_banned']): ?>
                        <label class="btn btn-success btn-sm banned" data-id="<?php echo $user['id']; ?>" data-banned="remove_banned"  title="Remove banned"> Remove ban </label>
                      <?php else: ?>
                        <label class="btn btn-danger btn-sm banned" data-id="<?php echo $user['id']; ?>" data-banned="add_banned" title="Add to banned">Ban user</label>
                      <?php endif; ?>
