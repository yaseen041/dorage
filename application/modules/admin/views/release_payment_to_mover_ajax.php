<div class="modal-dialog modal-md">
  <div class="modal-content">
    <div class="modal-header">
      <h4 class="modal-title" id="myModalLabel">Release Payment to Mover Owner</h4>
    ...
    <div class="modal-body">
      ...
      <div>
        <label>Total Crews: <b><?php echo $booking_detail['no_crews']; ?></b></label>
      </div>

      <div>
        <label>Crew Price: <b>$<?php echo $booking_detail['crew_charges']; ?>/hour</b></label>
      </div>

      <div>
        <label>Number of hours: <b><?php echo $booking_detail['no_hours']; ?></b></label>
      </div>
      ...
      <form id="releasePaymentMoverForm">
    ...
    <div class="modal-footer">
      <button class="btn btn-danger submitReleasePaymentMover">Submit</button>
    </div>
