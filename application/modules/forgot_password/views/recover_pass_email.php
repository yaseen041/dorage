													...
													<tr>
														<td class="table-col-td" width="478" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal; width: 478px;" valign="top" align="left">
															...
															<div style="font-family: Arial, sans-serif; line-height: 20px; color: #444444; font-size: 13px;">
																<legend><b style="color: #777777;">Hello <?php echo $userdata->first_name." ".$userdata->last_name; ?>,</b> </legend>
																<br><br>You recently requested to reset your password for your Dorage account.
																<br>
																To reset your password please follow the link below. 

																<br><br><br>

																<p> <a href="<?php echo base_url()?>forgot_password/reset_password/?email=<?php echo $email." &secret_key=".$forgot_pass_key ?>"> <?php echo base_url()?>forgot_password/reset_password/?email=<?php echo $email." &secret_key=".$forgot_pass_key ?></a> </p>
																<br>
																<hr>
																<br>
