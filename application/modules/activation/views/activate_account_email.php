													...
													<tr>
														<td class="table-col-td" width="478" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal; width: 478px;" valign="top" align="left">
															...
															<div style="font-family: Arial, sans-serif; line-height: 20px; color: #444444; font-size: 13px; width: 100%;">
																<legend><b style="color: #777777;"> Hi, </b> </legend>
																<br>
																Thanks for joining Dorage. Please confirm that your email address is correct to continue. click the link below to get started.
																<a href="<?php echo base_url(); ?>activation/confirm/<?php echo $userdata['activation_key']; ?>">
																	<?php echo base_url(); ?>activation/confirm/<?php echo $userdata['activation_key']; ?>
																</a>
																<br>
