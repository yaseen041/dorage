			...
			<div class="row">
				<div class="col-md-3 col-sm-4 col-xs-12">
					<div class="list-group policy-list edit-list" id="update-list">
						...
						<a href="javascript:void(0)" data-id="update_step2_ajax" class="list-group-item goto_to_step"> Pricing </a>

						<a href="<?php echo base_url(); ?>user/listings" class="list-group-item"> <i style="display:block;" class="fa fa-long-arrow-left"></i> Go back</a>
					</div>
				</div>
...
<script type="text/javascript">
	$(".goto_to_step").click(function() {
		...
		$.ajax({
			url:'<?php echo base_url(); ?>listing/mover/'+goto_to_step,
			type:'post',
