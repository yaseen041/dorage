			...
			<div class="row">
				<div class="col-md-3 col-sm-4 col-xs-12">
					<div class="list-group policy-list edit-list" id="update-list">
						...
						<a href="<?php echo base_url(); ?>listing/storage/step1_complete/<?php echo @$unique_id; ?>" class="list-group-item"> <i style="display:block;" class="fa fa-long-arrow-left"></i> Go back</a>
					</div>
				</div>
