                                                        ...
                                                        <td class="table-col-td" width="478" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal; width: 478px;" valign="top" align="left">
                                                            <table class="header-row" width="478" cellspacing="0" cellpadding="0" border="0" style="table-layout: fixed;">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td class="header-row-td" width="478" style="font-family: Arial, sans-serif; font-weight: normal; line-height: 19px; margin: 0px; font-size: 18px; padding-bottom: 5px; padding-top: 15px;" valign="top" align="left">
                                                                            <h3> Dear Admin, </h3>
                                                                            <p style="font-size: normal;"> New mover has been added. </p>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="header-row-td" width="478" style="font-family: Arial, sans-serif; font-weight: normal; line-height: 19px; color: #478fca; margin: 0px; font-size: 18px; padding-bottom: 10px; padding-top: 10px;" valign="top" align="left">
                                                                            <legend>
                                                                                <?php echo $mover_detail['title']; ?>
                                                                            </legend>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            ...
                                                            <div style="font-family: Arial, sans-serif; line-height: 20px; color: #444444; font-size: 13px; width: 100%;">
                                                                ...
                                                                <div style="width:60%; float: left;">
                                                                    <img src="<?php echo base_url(); ?>assets/storage_images/<?php echo get_list_image($mover_detail['id']); ?>" style="height: 150px; width:250px;">
                                                                </div>
                                                                ...
                                                                <div style="clear: both;">
                                                                    ...
                                                                    <a href="<?php echo base_url(); ?>details/mover/<?php echo $mover_detail['unique_id'].'/'.dorage_url_title($mover_detail['title']); ?>">
